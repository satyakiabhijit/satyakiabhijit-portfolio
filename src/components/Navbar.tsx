                    ...
                    <div className="hidden md:flex items-center gap-1">
                        {navLinks.map((link) => (
                            <motion.a
                                ...
                                className={`relative px-4 py-2 rounded-lg font-medium transition-colors ${activeSection === link.href.slice(1)
                        ...
                        <div className="px-4 py-6 space-y-2">
                            {navLinks.map((link, index) => (
                                <motion.a
                                    ...
                                    className={`block py-3 px-4 rounded-xl font-medium transition-colors ${activeSection === link.href.slice(1)
